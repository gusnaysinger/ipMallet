    ...
    <div class="card">
        <div class="card-header text-center">
            ...
            <ul class="nav nav-tabs card-header-tabs justify-content-end">
                ...
                <li class="nav-item">
                    <a class="nav-link" aria-current="true" href="./listmouse.php">Teclado</a>
                </li>
                <li class="nav-item">
        ...
        <div class="card-body p-4" style="height: 78vh;">
            <div class="col-md-12">
                <div class="btn-group" role="group" aria-label="Basic outlined example">
                        ...
                        <button type="button" id="btnRegmonitor" class="btn btn-primary">Monitor</button>
                ...
                <form class="row g-3" method="POST" action="./database/scriptmonitor.php">
                    ...
                    <div class="col-md-4">
                        <label for="groupcheckbox">Entradas</label>
                        <div class="input-group group-checkbox" id="groupcheckbox" style="font-size: 20px;">
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" name="checkentdvi" type="checkbox" value="DVI" id="checkdvi">
                                <label class="form-check-label" for="checkdvi">DVI</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" name="checkentvga" type="checkbox" value="VGA" id="checkvga">
                                <label class="form-check-label" for="checkvga">VGA</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" name="checkenthdmi" type="checkbox" value="HDMI" id="checkdvi">
                                <label class="form-check-label" for="checkhdmi">HDMI</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" name="checkentdp" type="checkbox" value="DISPLAY PORT" id="checkvga">
                                <label class="form-check-label" for="checkdp">DISPLAY PORT</label>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
