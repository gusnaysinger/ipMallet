    ...
    <div class="card">
        <div class="card-header text-center">
            ...
            <ul class="nav nav-tabs card-header-tabs justify-content-end">
                ...
                <li class="nav-item">
                    <a class="nav-link active" aria-current="true" href="./index.php">Computadores</a>
                </li>
                <li class="nav-item">
                ...
                if ($result->num_rows > 0) {
                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        */
                        ...
                        echo "<td>" . $row["n_ficha"] . "</td>";
                        echo "<td>" . $row["n_lacre"] . "</td>";
                        echo "<td>" . $row["os"] . "</td>";
                        echo "<td>" . $row["cpu"] . "</td>";
                        echo "<td>" . $row["ram"] . "</td>";
                        echo "<td>" . $row["rom"] . "</td>";
                        echo "<td style=\"max-width:200px\">" . nl2br(htmlspecialchars($row["obs"])) . "</td>";
                        echo "<td><a id=\"btn_delete\" href=\"./database/delete.php?id=" . htmlspecialchars($row["id"]) . "&db=" . $db ."&web=index\" class=\"btn btn-outline-danger delete\" role=\"button\"><i class=\"fa-solid fa-trash icon-editor-btn\"></i></a></td>";
                        echo "<td><a id=\"btn_edit\" href=\"editor.php?id=" . htmlspecialchars($row["id"]) . "\" class=\"btn btn-outline-primary\" role=\"button\"><i class='fa-solid fa-pen'></i></a></td>";
                        echo "</tr>";
                    }
                } else {
