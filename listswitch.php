    ...
    <div class="card">
        <div class="card-header text-center">
            ...
            <ul class="nav nav-tabs card-header-tabs justify-content-end">
                ...
                <li class="nav-item">
                    <a class="nav-link active" aria-current="true" href="./listswitch.php">Switch</a>
                </li>
                <li class="nav-item">
            ...
            <table class="table">
                ...
                if ($result->num_rows > 0) {
                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo "<td>" . $row["portas"] . " " . $row["user"] . "</td>";
                        echo "<td>" . $row["funciona"] . "</td>";
                        echo "<td>" . $row["local"] . "</td>";
                        echo "<td style=\"max-width:200px\">" . nl2br(htmlspecialchars($row["obs"])) . "</td>";
                        echo "<td><a id=\"btn_delete\" href=\"./database/delete.php?id=" . htmlspecialchars($row["id"]) ."&db=" . $db . "&web=listswitch\" class=\"btn btn-outline-danger delete\" role=\"button\"><i class=\"fa-solid fa-trash icon-editor-btn\"></i></a></td>";
                        echo "<td><a id=\"btn_edit\" href=\"./editorgeral.php?id=" . htmlspecialchars($row["id"]) . "&db=" . $db . "&web=listswitch" . "\" class=\"btn btn-outline-primary\" role=\"button\"><i class='fa-solid fa-pen'></i></a></td>";
                        echo "</tr>";
                    }
                } else {
