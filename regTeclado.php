        ...
        <div class="card-body p-4" style="height: 78vh;">
            <div class="col-md-12">
                <div class="btn-group" role="group" aria-label="Basic outlined example">
                        ...
                        <button type="button" id="btnRegteclado" class="btn btn-primary">Teclado</button>
            ...
            <form class="row g-3 mt-1" method="POST" action="./database/scriptteclado.php">
                <div class="col-md-4">
                ...
                <div class="col-md-2">
                    <label for="inputCon" class="form-label">Conector</label>
                    <select class="form-select" id="inputCon" name="con">
                        <option>USB</option>
                        <option>PS/2</option>
                    </select>
                </div>
